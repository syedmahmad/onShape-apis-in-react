...
export const getAssemblyDefinition = (elementID, cb) => {
    ...
    let path = "/onshape/getAssemblyDefinition" + '?documentID=' + searchParams.documentId + '&workspaceID=' + searchParams.workspaceId + '&elementID=' + elementID.payload;
